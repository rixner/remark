...
describe('Parser', () => {
  describe('splitting source into correct number of slides', () => {
    ...
    it('should handle multiple slides with the silent separator', () => {
      parser
        .parse('1\n<!-- break -->\n2\n<!-- break -->\n3')
  ...
  describe('parsing link definitions', () => {
    it('should extract link definitions', () => {
      parser
        .parse('[id]: http://url.com "title"')[0]
        .links.id.should.eql({ href: 'http://url.com', title: 'title' });
    });
  });
  ...
  describe('parsing macros', () => {
    it('should expand macro', () => {
      ...
      parser
        .parse('a ![:sum 1, 2, 3] b', macros)[0]
        .content.should.eql(['a 6 b']);
    });
    ...
    it('should expand macro recursively', () => {
      ...
      parser
        .parse('Uppercase => ![:addupper](word)', macros)[0]
        .content.should.eql(['Uppercase => WORD']);
    });
  });
  ...
  describe('parsing content classes', () => {
    ...
    it('should parse source in content classes', () => {
      parser.parse('.c1[.c2[x]]')[0].content.should.eql([
        {
          class: 'c1',
          block: false,
  ...
  describe('identifying continued slides', () => {
    it('should not identify normal, preceding slide as continued', () => {
      parser
        .parse('1\n--\n2\n---\n3')[0]
        .properties.continued.should.equal('false');
    });

    it('should identify continued slide as continued', () => {
      parser
        .parse('1\n--\n2\n---\n3')[1]
        .properties.continued.should.equal('true');
    });
