...
const remarkMin = fs.readFileSync(
  path.join(__dirname, '../dist/remark.min.js'),
  'utf8'
);
...
const template = fs.readFileSync(
  path.join(__dirname, '../src/templates/boilerplate-single.html.template'),
  'utf8'
);
...
fs.writeFileSync(
  path.join(__dirname, '../dist/boilerplate-single.html'),
  output
);
